function [fh,h1] = CEPRbc(time, y, LS, LW, LC)
%
% NBERbc creates shaded areas for the NBER recessions for plotyy.
% CEPRbc is just changing the dates in the original function
%
% - Usage - 
...
% Uncomment the below if I want NBER recessions in quarters
peak   = [1974+2/12; 1980; 1992; 2008;  2011+2/12]; %removed ; ; 2019.75
trough = [1975; 1982+2/12;  1993+2/12; 2009+1/12; 2013]; %removed ;2020.25
...
hold on
% -- fill uncall recession
%fill(reshape(repmat([2020 2022],2,1),[],1), repmat([-10000000; 10000000],2,1), [0.75 0.75 0], 'LineStyle', 'none')
